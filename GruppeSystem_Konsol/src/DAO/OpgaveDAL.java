...
public class OpgaveDAL {
    ...
    public void createOpgave(Opgave o, int projektid) throws DALException{
        {
		Connector.doUpdate
		("INSERT INTO opgave(opgname, opgdesc, projektid) VALUES (?,?,?)",
    ...
    public void DeleteOpgave(int opgaveId, int projektid) throws DALException{
        
        {
		Connector.doUpdate(
				"DELETE FROM opgave WHERE id = ?", opgaveId
